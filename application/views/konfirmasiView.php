                            ...
                            <div class="login-bg">                                                     
                                    ...
                                    <?php foreach ($cetak as $row) {?>
                                        <div class="form-group-inner">
                                            <p class="message-mg-rt "><strong>Konfirmasi Pengaturan File</strong> </p>
                                            <div class="row">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-xs-12 center-block" style="float:none">
                                            <div class="login-button-pro" style="text-align: center">
                                               <button class="btn btn-primary" onclick="window.location='home'">Selesai</button>
                                           </div>
                                       </div>
                                       <!-- <div class="col-xs-3"> </div> -->
                                   </div>
